...
class DisplayHelper {
  ...
  static ElementScreenSizes getElementScreenSize(BuildContext context) {
    final displayHelper = DisplayHelper(context);
    if (displayHelper.xs) {
      return ElementScreenSizes.xs;
    }
    if (displayHelper.sm) {
      return ElementScreenSizes.sm;
    }
    if (displayHelper.md) {
      return ElementScreenSizes.md;
    }
    if (displayHelper.lg) {
      return ElementScreenSizes.lg;
    }
    if (displayHelper.xl) {
      return ElementScreenSizes.xl;
    }
    return ElementScreenSizes.xxl;
  }
}
